...
- Symbols are prefixed with a backtick (\`) and can consist of zero or more alphanumeric characters or `.`. Symbols are mainly useful as handles to variable names or keys in dictionaries.
